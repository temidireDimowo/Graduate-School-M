...
(function (global) {
  ...
  console.assert(
    typeof global.Symbol() === "symbol" ||
      symbolForKey(String(global.Symbol("x"))) !== undefined
  );
  ...
  (function () {
    var nativeSymbols = typeof global.Symbol() === "symbol",
      ...
      $keys = Object.keys,
      $window_names =
        typeof window === "object" ? $getOwnPropertyNames(window) : [];
  ...
  define(Object, "setPrototypeOf", function setPrototypeOf(o, proto) {
  ...
  define(
    ...
    (function () {
      var next, result;
      for (next = 1; 1 + next !== 1; next = next / 2) result = next;
      return result;
    })()
  );
  ...
  define(Number, "isSafeInteger", function isSafeInteger(number) {
    ...
    var integer = ToInteger(number);
    if (integer !== number) return false;
    if (abs(integer) <= 0x20000000000000 - 1)
      // 2^53-1
      return true;
    return false;
  });
  ...
  define(Math, "trunc", function trunc(x) {
    x = Number(x);
    return $isNaN(x) ? NaN : x < 0 ? ceil(x) : floor(x);
  });
  ...
  define(String, "fromCodePoint", function fromCodePoint(/*...codePoints*/) {
  ...
  define(String, "raw", function raw(template /*, ...substitutions*/) {
    ...
    while (true) {
      ...
      if (nextIndex + 1 === literalSegments) return stringElements.join("");
  ...
  define(String.prototype, "codePointAt", function codePointAt(pos) {
    var o = strict(this);
    var s = String(o);
  ...
  define(String.prototype, "endsWith", function endsWith(searchString) {
  ...
  define(String.prototype, "includes", function includes(searchString) {
  ...
  define(
    ...
    function split(separator, limit) {
      var o = strict(this);
      if (HasProperty(separator, $$split)) return separator[$$split](o, limit);
  ...
  define(String.prototype, "startsWith", function startsWith(searchString) {
    var position = arguments[1];
  ...
  define(Array, "from", function from(items) {
    ...
    while (k < len) {
      ...
      if (mapping) mappedValue = mapfn.call(t, kValue, k);
  ...
  define(Array.prototype, "findIndex", function findIndex(predicate) {
    var o = ToObject(this);
    var lenValue = o.length;
    var len = ToLength(lenValue);
    if (!IsCallable(predicate)) throw TypeError();
  ...
  define($ArrayIteratorPrototype$, "next", function next() {
    ...
    if (itemKind.indexOf("value") !== -1) elementValue = a[elementKey];
  ...
  [
    ...
    if (!($TypedArrayName$ in global)) return;
    ...
    define($TypedArray$.prototype, "filter", function filter(callbackfn) {
    ...
    define($TypedArray$.prototype, "map", function map(callbackfn) {
      var thisArg = arguments[1];
      ...
      var a = undefined;
      var c = o.constructor;
      if (IsConstructor(c)) a = new c(len);
      if (a === undefined) a = new Array(len);
      var k = 0;
      while (k < len) {
    ...
    define($TypedArray$.prototype, "slice", function slice(start, end) {
      var o = ToObject(this);
      var lenVal = o.length;
      var len = ToLength(lenVal);
      var relativeStart = ToInteger(start);
    ...
    define($TypedArray$.prototype, $$iterator, $TypedArray$.prototype.values);
  ...
  (function () {
    ...
    Object.defineProperty(Map.prototype, "size", {
      get: function () {
        ...
        var count = 0;
        for (var i = 0; i < entries.keys.length; ++i) {
          if (entries.keys[i] !== empty) count = count + 1;
        }
        return count;
      },
    });
  ...
  (function () {
    ...
    Object.defineProperty(Set.prototype, "size", {
      get: function () {
        ...
        var count = 0;
        for (var i = 0; i < entries.length; ++i) {
          if (entries[i] !== empty) count = count + 1;
        }
        return count;
      },
    });
  ...
  (function () {
    ...
    define(WeakMap.prototype, "get", function get(key, defaultValue) {
      var M = strict(this);
      if (Type(M) !== "object") throw TypeError();
      if (M["[[WeakMapData]]"] === undefined) throw TypeError();
      if (Type(key) !== "object") throw TypeError("Expected object");
  ...
  (function () {
    if (!("ArrayBuffer" in global)) return;
  ...
  (function () {
    ...
    function PromiseResolveFunction() {
      var F = function (resolution) {
        ...
        EnqueueJob("PromiseJobs", PromiseResolveThenableJob, [
          promise,
          resolution,
          then,
        ]);
    ...
    function PromiseResolveThenableJob(promiseToResolve, thenable, then) {
      ...
      try {
        ...
        var status = resolvingFunctions["[[Reject]]"].call(
          undefined,
          thenCallResult
        );
        NextJob(status);
      ...
      while (true) {
        ...
        if (!next) {
          ...
          if (remainingElementsCount.value === 0) {
            var resolveResult = promiseCapability["[[Resolve]]"].apply(
              undefined,
              values
            );
          }
  ...
  (function () {
    ...
    define(Reflect, "construct", function construct(target, argumentsList) {
    ...
    define(Reflect, "deleteProperty", function deleteProperty(target, name) {
      try {
        delete target[name];
    ...
    define(Reflect, "preventExtensions", function preventExtensions(target) {
      try {
    ...
    define(Reflect, "set", function set(target, name, value, receiver) {
      target = ToObject(target);
      name = String(name);
      receiver = receiver === undefined ? target : ToObject(receiver);
      var desc = getPropertyDescriptor(target, name);
    ...
    define(Reflect, "setPrototypeOf", function setPrototypeOf(target, proto) {
      try {
...
(function (global) {
  ...
  define(Array.prototype, "includes", function includes(target) {
    ...
    while (k < len) {
      var elementK = o[k];
      if (SameValueZero(o[k], target)) return true;
      k += 1;
    }
    return false;
  });
...
(function (global) {
  ...
  // Needed for: IE9-
  (function () {
    if ("atob" in global && "btoa" in global) return;
  ...
  (function () {
    if ("requestAnimationFrame" in global) return;
...
(function (global) {
  ...
  (function () {
    ...
    (function () {
      ...
      global.DOMTokenList.prototype.toggle = function toggle(
        token /*, force*/
      ) {
        var force = arguments[1];
        if (force === undefined) {
...
(function (global) {
  ...
  function Request(input, init) {
    ...
    if ("body" in init) this._stream = init.body;
  ...
  function fetch(input, init) {
    return new Promise(function (resolve, reject) {
      ...
      for (
        var iter = r.headers[Symbol.iterator](), step = iter.next();
        !step.done;
        step = iter.next()
      )
        xhr.setRequestHeader(step.value[0], step.value[1]);

      if (r.credentials === "include") xhr.withCredentials = true;

      xhr.onreadystatechange = function () {
        if (xhr.readyState !== XMLHttpRequest.DONE) return;
        if (xhr.status === 0) reject(new TypeError("Network error"));
        else resolve(new Response(xhr));
      };
